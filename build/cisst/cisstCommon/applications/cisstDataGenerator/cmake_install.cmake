# Install script for directory: /home/utc_sim/ros2_dvrk/src/cisst-saw/cisst/cisstCommon/applications/cisstDataGenerator
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xcisstCommonx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/utc_sim/ros2_dvrk/build/cisst/bin/cisstDataGenerator")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/cisstDataGenerator" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/cisstDataGenerator")
