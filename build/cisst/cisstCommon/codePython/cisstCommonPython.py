...
class cmnGenericObject(object):
    ...
    def Scalar(self, arg2):
        r"""Scalar(cmnGenericObject self, size_t const arg2) -> double"""
        return _cisstCommonPython.cmnGenericObject_Scalar(self, arg2)

    def ScalarDescription(self, arg2, arg3):
        r"""ScalarDescription(cmnGenericObject self, size_t const arg2, std::string const & arg3) -> std::string"""
        return _cisstCommonPython.cmnGenericObject_ScalarDescription(self, arg2, arg3)
...
class cmnPath(cmnGenericObject):
    ...
    @staticmethod
    def RenameFile(fullPathOld, fullPathNew):
        r"""RenameFile(std::string const & fullPathOld, std::string const & fullPathNew) -> bool"""
        return _cisstCommonPython.cmnPath_RenameFile(fullPathOld, fullPathNew)
...
def cmnPath_RenameFile(fullPathOld, fullPathNew):
    r"""cmnPath_RenameFile(std::string const & fullPathOld, std::string const & fullPathNew) -> bool"""
    return _cisstCommonPython.cmnPath_RenameFile(fullPathOld, fullPathNew)
...
CMN_JOINT_UNDEFINED = _cisstCommonPython.CMN_JOINT_UNDEFINED

CMN_JOINT_PRISMATIC = _cisstCommonPython.CMN_JOINT_PRISMATIC

CMN_JOINT_REVOLUTE = _cisstCommonPython.CMN_JOINT_REVOLUTE

CMN_JOINT_UNIVERSAL = _cisstCommonPython.CMN_JOINT_UNIVERSAL

CMN_JOINT_BALL_SOCKET = _cisstCommonPython.CMN_JOINT_BALL_SOCKET

CMN_JOINT_INACTIVE = _cisstCommonPython.CMN_JOINT_INACTIVE


def cmnJointTypeToString(value):
    r"""cmnJointTypeToString(cmnJointType const & value) -> std::string"""
    return _cisstCommonPython.cmnJointTypeToString(value)

def cmnJointTypeFromString(value):
    r"""cmnJointTypeFromString(std::string const & value) -> cmnJointType"""
    return _cisstCommonPython.cmnJointTypeFromString(value)

def cmnJointTypeVectorInt():
    r"""cmnJointTypeVectorInt() -> std::vector< int,std::allocator< int > > const &"""
    return _cisstCommonPython.cmnJointTypeVectorInt()

def cmnJointTypeVectorString():
    r"""cmnJointTypeVectorString() -> std::vector< std::string,std::allocator< std::string > > const &"""
    return _cisstCommonPython.cmnJointTypeVectorString()
