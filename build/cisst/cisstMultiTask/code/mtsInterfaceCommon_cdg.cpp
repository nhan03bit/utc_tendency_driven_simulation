...
// cisst version: 1.4.0
// source file: /home/utc_sim/ros2_dvrk/src/cisst-saw/cisst/cisstMultiTask/code/../mtsInterfaceCommon.cdg
...
void mtsCommandWriteDescription::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < ArgumentPrototypeSerialized");
        }
    } else {
...
void mtsCommandQualifiedReadDescription::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < Argument1PrototypeSerialized");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < Argument2PrototypeSerialized");
        }
    } else {
...
void mtsCommandVoidReturnDescription::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < ResultPrototypeSerialized");
        }
    } else {
...
void mtsInterfaceProvidedDescription::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < InterfaceName");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < CommandsVoid");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < CommandsWrite");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < CommandsRead");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < CommandsQualifiedRead");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < CommandsVoidReturn");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < CommandsWriteReturn");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < EventsVoid");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < EventsWrite");
        }
    } else {
...
void mtsInterfaceRequiredDescription::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < FunctionVoidNames");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < FunctionWriteNames");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < FunctionReadNames");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < FunctionQualifiedReadNames");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < FunctionVoidReturnNames");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < FunctionWriteReturnNames");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < EventHandlersVoid");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < EventHandlersWrite");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < IsRequired");
        }
    } else {
