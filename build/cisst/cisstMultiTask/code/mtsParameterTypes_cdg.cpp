...
// cisst version: 1.4.0
// source file: /home/utc_sim/ros2_dvrk/src/cisst-saw/cisst/cisstMultiTask/code/../mtsParameterTypes.cdg
...
void mtsDescriptionComponent::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < ProcessName");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < ComponentName");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < ClassName");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < ConstructorArgSerialized");
        }
    } else {
...
void mtsDescriptionComponentClass::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < ArgType");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < ArgTypeId");
        }
    } else {
...
void mtsDescriptionInterface::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < InterfaceRequiredNames");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < InterfaceProvidedNames");
        }
    } else {
...
void mtsDescriptionConnection::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < Client");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < Server");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < ConnectionID");
        }
    };
}
#endif // CISST_HAS_JSON
...
void mtsComponentStatusControl::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < DelayInSecond");
        }
    };
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < Command");
        }
    } else {
...
void mtsComponentStateChange::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < NewState");
        }
    } else {
...
void mtsDescriptionLoadLibrary::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < LibraryName");
        }
    } else {
...
void mtsEndUserInterfaceArg::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < OriginalInterface");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < UserName");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < EndUserInterface");
        }
    } else {
...
void mtsMessage::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < Message");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < Counter");
        }
    };
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < Timestamp");
        }
    } else {
...
void mtsTaskConstructorArg::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < StateTableSize");
        }
    };
}
#endif // CISST_HAS_JSON
...
void mtsTaskContinuousConstructorArg::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < NewThread");
        }
    };
}
#endif // CISST_HAS_JSON
...
void mtsTaskPeriodicConstructorArg::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < IsHardRealTime");
        }
    };
    field__cdg = jsonValue["StateTableSize"];
    if (!field__cdg.empty()) {
