...
prmActuatorJointCoupling::prmActuatorJointCoupling(void):
    mActuatorToJointPosition(vctDoubleMat(0, 0))
...
void prmActuatorJointCoupling::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mActuatorToJointPosition");
        }
    };
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mJointToActuatorPosition");
        }
    };
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mActuatorToJointEffort");
        }
    };
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mJointToActuatorEffort");
        }
    };
}
