...
void prmConfigurationJoint::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        ...
        cmnThrow("cmnDataJson<std::vector<std::string>>::DeSerializeText: empty JSON value for: mName");
    };
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mType");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mPositionMin");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mPositionMax");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mVelocityMin");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mVelocityMax");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mAccelerationMin");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mAccelerationMax");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mEffortMin");
        }
    } else {
    ...
    if (!field__cdg.empty()) {
        try {
            ...
            cmnThrow(std::string(e.what()) + " < mEffortMax");
        }
    } else {
