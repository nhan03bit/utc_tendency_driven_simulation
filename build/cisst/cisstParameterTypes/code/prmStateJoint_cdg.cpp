...
// cisst version: 1.4.0
// source file: /home/utc_sim/ros2_dvrk/src/cisst-saw/cisst/cisstParameterTypes/code/../prmStateJoint.cdg
...
void prmStateJoint::GetName(std::vector<std::string> & placeHolder) const
{
    placeHolder = this->mName;
}

void prmStateJoint::SetName(const std::vector<std::string> & newValue)
{
    this->mName = newValue;
}
...
/* accessors is set to: all */
const std::vector<std::string> & prmStateJoint::Name(void) const
{
    return this->mName;
}

std::vector<std::string> & prmStateJoint::Name(void)
{
    return this->mName;
}
