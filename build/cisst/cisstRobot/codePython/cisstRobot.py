...
class robManipulator(object):
    ...
    def LoadRobot(self, *args):
        ...
        LoadRobot(robManipulator self, istream ifs) -> robManipulator::Errno
    ...
    def RNE_MDH(self, *args):
        ...
        RNE_MDH(robManipulator self, vctDynamicVector< double > const & q, vctDynamicVector< double > const & qd, vctDynamicVector< double > const & qdd, vctFixedSizeVector< double,6 > const & f, vct3 const & g) -> vctDynamicVector< double >
        """
        return _cisstRobotPython.robManipulator_RNE_MDH(self, *args)
    ...
    def CCG_MDH(self, *args):
        ...
        CCG_MDH(robManipulator self, vctDynamicVector< double > const & q, vctDynamicVector< double > const & qd, vct3 const & g) -> vctDynamicVector< double >
        """
        return _cisstRobotPython.robManipulator_CCG_MDH(self, *args)
    ...
    def GetJointTypes(self, types):
        r"""GetJointTypes(robManipulator self, std::vector< cmnJointType,std::allocator< cmnJointType > > & types)"""
...
class robLink(object):
    ...
    def GetType(self):
        r"""GetType(robLink self) -> cmnJointType"""
...
class robJoint(object):
    ...
    def __init__(self, *args):
        ...
        __init__(robJoint self, cmnJointType type, robJoint::Mode mode, double offset, double min, double max, double ftmax) -> robJoint
        """
    ...
    def GetType(self):
        r"""GetType(robJoint self) -> cmnJointType"""
