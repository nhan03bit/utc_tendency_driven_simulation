...
// cisst version: 1.4.0
// source file: /home/utc_sim/ros2_dvrk/src/cisst-saw/cisst/cisstParameterTypes/code/../prmPositionJointGet.cdg
...
#endif
    inline  vctDynamicVector<double> GetPosition(void) const {
        return mPosition;
    }
...
#endif
    inline  vctDynamicVector<double> GetTimestamps(void) const {
        return mTimestamps;
    }
