...
class osaDynamicLoader(object):
    r"""Proxy of C++ osaDynamicLoader class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(osaDynamicLoader self) -> osaDynamicLoader"""
        _cisstOSAbstractionPython.osaDynamicLoader_swiginit(self, _cisstOSAbstractionPython.new_osaDynamicLoader())
    __swig_destroy__ = _cisstOSAbstractionPython.delete_osaDynamicLoader

    def Load(self, *args):
        r"""
        Load(osaDynamicLoader self, char const * file, char const * path=None) -> bool
        Load(osaDynamicLoader self, std::string const & file, std::string const & path="") -> bool
        """
        return _cisstOSAbstractionPython.osaDynamicLoader_Load(self, *args)

    def UnLoad(self):
        r"""UnLoad(osaDynamicLoader self)"""
        return _cisstOSAbstractionPython.osaDynamicLoader_UnLoad(self)

# Register osaDynamicLoader in _cisstOSAbstractionPython:
_cisstOSAbstractionPython.osaDynamicLoader_swigregister(osaDynamicLoader)
