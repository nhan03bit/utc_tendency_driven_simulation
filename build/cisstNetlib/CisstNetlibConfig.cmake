...
# retrieve the path where cisstNetlib was installed
...
find_path (cisstNetlib_INCLUDE_DIR
           NAMES cisstNetlib.h
           PATHS "${cisstNetlib_CONFIG_FILE_DIR}/../../include" "${cisstNetlib_CONFIG_FILE_DIR}/../include")

# find all libraries
set (cisstNetlib_LIBRARIES_SHORT_NAMES
     "cisstNetlib;cisstNetlib_hanson_haskell;cisstNetlib_lawson_hanson;cisstNetlib_lapack;cisstNetlib_blas;cisstNetlib_f2c")
...
foreach (lib ${cisstNetlib_LIBRARIES_SHORT_NAMES})
  find_library (cisstNetlib_LIBRARY_${lib} ${lib}
                PATHS "${cisstNetlib_CONFIG_FILE_DIR}/../../lib" "${cisstNetlib_CONFIG_FILE_DIR}/../lib")
