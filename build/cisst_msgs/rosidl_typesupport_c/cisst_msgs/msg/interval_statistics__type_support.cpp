...
static const _IntervalStatistics_type_support_symbol_names_t _IntervalStatistics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cisst_msgs, msg, IntervalStatistics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cisst_msgs, msg, IntervalStatistics)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cisst_msgs, msg, IntervalStatistics)() {
  return &::cisst_msgs::msg::rosidl_typesupport_c::IntervalStatistics_message_type_support_handle;
}
