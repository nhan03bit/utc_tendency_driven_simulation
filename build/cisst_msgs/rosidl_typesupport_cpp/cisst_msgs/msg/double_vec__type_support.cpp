...
static const _DoubleVec_type_support_symbol_names_t _DoubleVec_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cisst_msgs, msg, DoubleVec)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cisst_msgs, msg, DoubleVec)),
  }
};
...
{
  return &::cisst_msgs::msg::rosidl_typesupport_cpp::DoubleVec_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cisst_msgs, msg, DoubleVec)() {
  return get_message_type_support_handle<cisst_msgs::msg::DoubleVec>();
}
