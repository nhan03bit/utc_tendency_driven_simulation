...
class Metaclass_JointServo(type):
    """Metaclass of message 'JointServo'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'crtk_msgs.msg.JointServo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__joint_servo
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__joint_servo
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__joint_servo
            cls._TYPE_SUPPORT = module.type_support_msg__msg__joint_servo
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__joint_servo
...
class JointServo(metaclass=Metaclass_JointServo):
    """Message class 'JointServo'."""
    ...
    _fields_and_field_types = {
        ...
        'mode': 'sequence<crtk_msgs/SetpointMode>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('double')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('double')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['crtk_msgs', 'msg'], 'SetpointMode')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'mode' field must be a set or sequence and each value of type 'SetpointMode'"
        self._mode = value
