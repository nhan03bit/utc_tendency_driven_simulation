...
bool crtk_msgs__msg__joint_servo__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crtk_msgs.msg._joint_servo.JointServo", full_classname_dest, 37) == 0);
  }
  crtk_msgs__msg__JointServo * ros_message = _ros_message;
  {  // header
  ...
  {  // mode
    ...
    if (!crtk_msgs__msg__SetpointMode__Sequence__init(&(ros_message->mode), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create crtk_msgs__msg__SetpointMode__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    crtk_msgs__msg__SetpointMode * dest = ros_message->mode.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of JointServo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("crtk_msgs.msg._joint_servo");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointServo");
