...
bool crtk_msgs__msg__setpoint_mode__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crtk_msgs.msg._setpoint_mode.SetpointMode", full_classname_dest, 41) == 0);
  }
  crtk_msgs__msg__SetpointMode * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of SetpointMode */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("crtk_msgs.msg._setpoint_mode");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetpointMode");
