...
#include "crtk_msgs/msg/detail/cartesian_state__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/bool__functions.h"  // pose_is_valid, twist_is_valid, wrench_is_valid
...
using _CartesianState__ros_msg_type = crtk_msgs__msg__CartesianState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: twist_is_valid
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->twist_is_valid, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: wrench_is_valid
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->wrench_is_valid, cdr))
    {
      return false;
    }
  }
...
static uint32_t _CartesianState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crtk_msgs__msg__CartesianState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crtk_msgs__msg__CartesianState;
    is_plain =
      (
...
static size_t _CartesianState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crtk_msgs__msg__CartesianState(
