...
#include "crtk_msgs/msg/detail/joint_servo__rosidl_typesupport_fastrtps_c.h"
...
#include "crtk_msgs/msg/detail/setpoint_mode__functions.h"  // mode
...
using _JointServo__ros_msg_type = crtk_msgs__msg__JointServo;

static bool _JointServo__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JointServo__ros_msg_type * ros_message = static_cast<const _JointServo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: mode
  {
    ...
    size_t size = ros_message->mode.size;
    auto array_ptr = ros_message->mode.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
...
static bool _JointServo__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _JointServo__ros_msg_type * ros_message = static_cast<_JointServo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: mode
  {
    ...
    if (ros_message->mode.data) {
      crtk_msgs__msg__SetpointMode__Sequence__fini(&ros_message->mode);
    }
    if (!crtk_msgs__msg__SetpointMode__Sequence__init(&ros_message->mode, size)) {
      fprintf(stderr, "failed to create array for field 'mode'");
      return false;
    }
    auto array_ptr = ros_message->mode.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_crtk_msgs__msg__JointServo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointServo__ros_msg_type * ros_message = static_cast<const _JointServo__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name mode
  {
    size_t array_size = ros_message->mode.size;
    auto array_ptr = ros_message->mode.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
...
static uint32_t _JointServo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crtk_msgs__msg__JointServo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crtk_msgs
size_t max_serialized_size_crtk_msgs__msg__JointServo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crtk_msgs__msg__JointServo;
    is_plain =
      (
...
static size_t _JointServo__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_crtk_msgs__msg__JointServo(
...
static message_type_support_callbacks_t __callbacks_JointServo = {
  "crtk_msgs::msg",
  "JointServo",
  _JointServo__cdr_serialize,
  _JointServo__cdr_deserialize,
  _JointServo__get_serialized_size,
  _JointServo__max_serialized_size
};

static rosidl_message_type_support_t _JointServo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointServo,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crtk_msgs, msg, JointServo)() {
  return &_JointServo__type_support;
}
