...
#include "crtk_msgs/msg/detail/operating_state__rosidl_typesupport_fastrtps_c.h"
...
using _OperatingState__ros_msg_type = crtk_msgs__msg__OperatingState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _OperatingState__ros_msg_type * ros_message = static_cast<const _OperatingState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _OperatingState__ros_msg_type * ros_message = static_cast<_OperatingState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _OperatingState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crtk_msgs__msg__OperatingState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crtk_msgs__msg__OperatingState;
    is_plain =
      (
...
static size_t _OperatingState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crtk_msgs__msg__OperatingState(
...
static message_type_support_callbacks_t __callbacks_OperatingState = {
  "crtk_msgs::msg",
  "OperatingState",
...
static rosidl_message_type_support_t _OperatingState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_OperatingState,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crtk_msgs, msg, OperatingState)() {
  return &_OperatingState__type_support;
}
