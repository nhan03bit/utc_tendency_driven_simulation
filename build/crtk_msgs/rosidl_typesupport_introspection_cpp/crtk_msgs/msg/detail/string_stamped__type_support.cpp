...
{
  new (message_memory) crtk_msgs::msg::StringStamped(_init);
}

void StringStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<crtk_msgs::msg::StringStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StringStamped_message_member_array[2] = {
  {
    ...
    offsetof(crtk_msgs::msg::StringStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(crtk_msgs::msg::StringStamped, string),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StringStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(crtk_msgs::msg::StringStamped),
...
{
  return &::crtk_msgs::msg::rosidl_typesupport_introspection_cpp::StringStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crtk_msgs, msg, StringStamped)() {
  return &::crtk_msgs::msg::rosidl_typesupport_introspection_cpp::StringStamped_message_type_support_handle;
}
