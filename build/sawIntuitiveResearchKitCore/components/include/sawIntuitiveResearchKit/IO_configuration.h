...
#pragma once
#ifndef _sawIntuitiveResearchKit_IO_configuration_h
#define _sawIntuitiveResearchKit_IO_configuration_h
...
/* source line: 9 */
namespace dvrk {
class CISST_EXPORT IO_configuration
{
 /* default constructors and destructors. */
 public:
    IO_configuration(void);
    IO_configuration(const IO_configuration & other);
    IO_configuration & operator = (const IO_configuration & other);
    ~IO_configuration();
...
/* source line: 33 */
 ...
 public:
    void Copy(const IO_configuration & source);
...
typedef mtsGenericObjectProxy<dvrk::IO_configuration> dvrk_IO_configurationProxy;
CMN_DECLARE_SERVICES_INSTANTIATION(dvrk_IO_configurationProxy);

/* default functions */
void CISST_EXPORT cmnSerializeRaw(std::ostream & outputStream, const dvrk::IO_configuration & object);
void CISST_EXPORT cmnDeSerializeRaw(std::istream & inputStream, dvrk::IO_configuration & placeHolder);
/* data functions */
template <> class cmnData<dvrk::IO_configuration > {
public: 
    enum {IS_SPECIALIZED = 1};
    typedef dvrk::IO_configuration DataType;
...
inline std::ostream & operator << (std::ostream & outputStream, const dvrk::IO_configuration & data) {
    outputStream << cmnData<dvrk::IO_configuration >::HumanReadable(data);
    return outputStream;
}
#if CISST_HAS_JSON
template <> void CISST_EXPORT cmnDataJSON<dvrk::IO_configuration >::SerializeText(const dvrk::IO_configuration & data, Json::Value & jsonValue);
template <> void CISST_EXPORT cmnDataJSON<dvrk::IO_configuration >::DeSerializeText(dvrk::IO_configuration & data, const Json::Value & jsonValue) CISST_THROW(std::runtime_error);
#endif // CISST_HAS_JSON


#endif // _sawIntuitiveResearchKit_IO_configuration_h
