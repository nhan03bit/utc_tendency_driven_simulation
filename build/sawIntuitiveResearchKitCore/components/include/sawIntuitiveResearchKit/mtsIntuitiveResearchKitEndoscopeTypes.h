...
/* source line: 10 */
public:
    enum Type {SCOPE_ERROR = 0, SCOPE_NONE, SCOPE_Classic_SD_STRAIGHT, SCOPE_Classic_SD_UP, SCOPE_Classic_SD_DOWN, SCOPE_Classic_HD_STRAIGHT, SCOPE_Classic_HD_UP, SCOPE_Classic_HD_DOWN, SCOPE_Si_HD_STRAIGHT, SCOPE_Si_HD_UP, SCOPE_Si_HD_DOWN, SCOPE_Custom_STRAIGHT, SCOPE_Custom_UP, SCOPE_Custom_DOWN };
