...
// cisst version: 1.4.0
// source file: /home/utc_sim/ros2_dvrk/src/cisst-saw/cisst/cisstParameterTypes/code/../prmActuatorJointCoupling.cdg
...
#endif
    inline  vctDoubleMat GetActuatorToJointPosition(void) const {
        return mActuatorToJointPosition;
    }
...
#endif
    inline  vctDoubleMat GetJointToActuatorPosition(void) const {
        return mJointToActuatorPosition;
    }
...
#endif
    inline  vctDoubleMat GetActuatorToJointEffort(void) const {
        return mActuatorToJointEffort;
    }
...
#endif
    inline  vctDoubleMat GetJointToActuatorEffort(void) const {
        return mJointToActuatorEffort;
    }
