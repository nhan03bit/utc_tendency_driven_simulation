...
// cisst version: 1.4.0
// source file: /home/utc_sim/ros2_dvrk/src/cisst-saw/cisst/cisstParameterTypes/code/../prmOperatingState.cdg
...
#endif
    inline  prmOperatingState::StateType GetState(void) const {
        return mState;
    }
...
#endif
    inline  std::string GetSubState(void) const {
        return mSubState;
    }
...
#endif
    inline  bool GetIsHomed(void) const {
        return mIsHomed;
    }
...
#endif
    inline  bool GetIsBusy(void) const {
        return mIsBusy;
    }
