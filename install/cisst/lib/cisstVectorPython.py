...
class vctFrm3(object):
    ...
    def GetTranslation(self):
        r"""GetTranslation(vctFrm3 self) -> vctFrameBase< vctMatrixRotation3< double,VCT_ROW_MAJOR > >::TranslationType"""
        return _cisstVectorPython.vctFrm3_GetTranslation(self)

    def SetTranslation(self, trans):
        r"""SetTranslation(vctFrm3 self, vctFrameBase< vctMatrixRotation3< double,VCT_ROW_MAJOR > >::TranslationType const & trans)"""
        return _cisstVectorPython.vctFrm3_SetTranslation(self, trans)

    def GetRotation(self):
        r"""GetRotation(vctFrm3 self) -> vctFrameBase< vctMatrixRotation3< double,VCT_ROW_MAJOR > >::RotationType"""
        return _cisstVectorPython.vctFrm3_GetRotation(self)

    def SetRotation(self, rot):
        r"""SetRotation(vctFrm3 self, vctFrameBase< vctMatrixRotation3< double,VCT_ROW_MAJOR > >::RotationType const & rot)"""
        return _cisstVectorPython.vctFrm3_SetRotation(self, rot)
