...
#pragma once
#ifndef _sawIntuitiveResearchKit_IO_proxy_configuration_h
#define _sawIntuitiveResearchKit_IO_proxy_configuration_h
...
/* source line: 8 */
namespace dvrk {
class CISST_EXPORT IO_proxy_configuration
{
 /* default constructors and destructors. */
 public:
    IO_proxy_configuration(void);
    IO_proxy_configuration(const IO_proxy_configuration & other);
    IO_proxy_configuration & operator = (const IO_proxy_configuration & other);
    ~IO_proxy_configuration();
...
/* source line: 39 */
 public:
    double watchdog_timeout; // watchdog_timeout
/* source line: 46 */
 public:
    std::vector<std::string> configuration_files; // configuration_files
/* source line: 53 */
 public:
    bool close_all_relays; // close_all_relays
    /* default methods */
 public:
 ...
 public:
    void Copy(const IO_proxy_configuration & source);
...
typedef mtsGenericObjectProxy<dvrk::IO_proxy_configuration> dvrk_IO_proxy_configurationProxy;
CMN_DECLARE_SERVICES_INSTANTIATION(dvrk_IO_proxy_configurationProxy);

/* default functions */
void CISST_EXPORT cmnSerializeRaw(std::ostream & outputStream, const dvrk::IO_proxy_configuration & object);
void CISST_EXPORT cmnDeSerializeRaw(std::istream & inputStream, dvrk::IO_proxy_configuration & placeHolder);
/* data functions */
template <> class cmnData<dvrk::IO_proxy_configuration > {
public: 
    enum {IS_SPECIALIZED = 1};
    typedef dvrk::IO_proxy_configuration DataType;
...
inline std::ostream & operator << (std::ostream & outputStream, const dvrk::IO_proxy_configuration & data) {
    outputStream << cmnData<dvrk::IO_proxy_configuration >::HumanReadable(data);
    return outputStream;
}
#if CISST_HAS_JSON
template <> void CISST_EXPORT cmnDataJSON<dvrk::IO_proxy_configuration >::SerializeText(const dvrk::IO_proxy_configuration & data, Json::Value & jsonValue);
template <> void CISST_EXPORT cmnDataJSON<dvrk::IO_proxy_configuration >::DeSerializeText(dvrk::IO_proxy_configuration & data, const Json::Value & jsonValue) CISST_THROW(std::runtime_error);
#endif // CISST_HAS_JSON


#endif // _sawIntuitiveResearchKit_IO_proxy_configuration_h
