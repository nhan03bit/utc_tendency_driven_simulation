...
#pragma once
#ifndef _sawIntuitiveResearchKit_teleop_ECM_configuration_h
#define _sawIntuitiveResearchKit_teleop_ECM_configuration_h
...
/* source line: 9 */
namespace dvrk {
class CISST_EXPORT teleop_ECM_configuration
{
 /* default constructors and destructors. */
 public:
    teleop_ECM_configuration(void);
    teleop_ECM_configuration(const teleop_ECM_configuration & other);
    teleop_ECM_configuration & operator = (const teleop_ECM_configuration & other);
    ~teleop_ECM_configuration();
...
/* source line: 14 */
 ...
 public:
    void Copy(const teleop_ECM_configuration & source);
...
typedef mtsGenericObjectProxy<dvrk::teleop_ECM_configuration> dvrk_teleop_ECM_configurationProxy;
CMN_DECLARE_SERVICES_INSTANTIATION(dvrk_teleop_ECM_configurationProxy);

/* default functions */
void CISST_EXPORT cmnSerializeRaw(std::ostream & outputStream, const dvrk::teleop_ECM_configuration & object);
void CISST_EXPORT cmnDeSerializeRaw(std::istream & inputStream, dvrk::teleop_ECM_configuration & placeHolder);
/* data functions */
template <> class cmnData<dvrk::teleop_ECM_configuration > {
public: 
    enum {IS_SPECIALIZED = 1};
    typedef dvrk::teleop_ECM_configuration DataType;
...
inline std::ostream & operator << (std::ostream & outputStream, const dvrk::teleop_ECM_configuration & data) {
    outputStream << cmnData<dvrk::teleop_ECM_configuration >::HumanReadable(data);
    return outputStream;
}
#if CISST_HAS_JSON
template <> void CISST_EXPORT cmnDataJSON<dvrk::teleop_ECM_configuration >::SerializeText(const dvrk::teleop_ECM_configuration & data, Json::Value & jsonValue);
template <> void CISST_EXPORT cmnDataJSON<dvrk::teleop_ECM_configuration >::DeSerializeText(dvrk::teleop_ECM_configuration & data, const Json::Value & jsonValue) CISST_THROW(std::runtime_error);
#endif // CISST_HAS_JSON


#endif // _sawIntuitiveResearchKit_teleop_ECM_configuration_h
