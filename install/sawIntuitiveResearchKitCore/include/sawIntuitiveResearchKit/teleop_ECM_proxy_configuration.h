...
#pragma once
#ifndef _sawIntuitiveResearchKit_teleop_ECM_proxy_configuration_h
#define _sawIntuitiveResearchKit_teleop_ECM_proxy_configuration_h
...
/* source line: 10 */
namespace dvrk {
class CISST_EXPORT teleop_ECM_proxy_configuration
{
 /* default constructors and destructors. */
 public:
    teleop_ECM_proxy_configuration(void);
    teleop_ECM_proxy_configuration(const teleop_ECM_proxy_configuration & other);
    teleop_ECM_proxy_configuration & operator = (const teleop_ECM_proxy_configuration & other);
    ~teleop_ECM_proxy_configuration();

/* source line: 15 */
 public:
    dvrk::teleop_ECM_type type; // type
/* source line: 22 */
 public:
    std::string MTML; // MTML
/* source line: 28 */
 public:
    std::string MTMR; // MTMR
/* source line: 34 */
 public:
    std::string ECM; // ECM
/* source line: 40 */
...
/* source line: 47 */
 ...
 public:
    void Copy(const teleop_ECM_proxy_configuration & source);
...
typedef mtsGenericObjectProxy<dvrk::teleop_ECM_proxy_configuration> dvrk_teleop_ECM_proxy_configurationProxy;
CMN_DECLARE_SERVICES_INSTANTIATION(dvrk_teleop_ECM_proxy_configurationProxy);

/* default functions */
void CISST_EXPORT cmnSerializeRaw(std::ostream & outputStream, const dvrk::teleop_ECM_proxy_configuration & object);
void CISST_EXPORT cmnDeSerializeRaw(std::istream & inputStream, dvrk::teleop_ECM_proxy_configuration & placeHolder);
/* data functions */
template <> class cmnData<dvrk::teleop_ECM_proxy_configuration > {
public: 
    enum {IS_SPECIALIZED = 1};
    typedef dvrk::teleop_ECM_proxy_configuration DataType;
...
inline std::ostream & operator << (std::ostream & outputStream, const dvrk::teleop_ECM_proxy_configuration & data) {
    outputStream << cmnData<dvrk::teleop_ECM_proxy_configuration >::HumanReadable(data);
    return outputStream;
}
#if CISST_HAS_JSON
template <> void CISST_EXPORT cmnDataJSON<dvrk::teleop_ECM_proxy_configuration >::SerializeText(const dvrk::teleop_ECM_proxy_configuration & data, Json::Value & jsonValue);
template <> void CISST_EXPORT cmnDataJSON<dvrk::teleop_ECM_proxy_configuration >::DeSerializeText(dvrk::teleop_ECM_proxy_configuration & data, const Json::Value & jsonValue) CISST_THROW(std::runtime_error);
#endif // CISST_HAS_JSON


#endif // _sawIntuitiveResearchKit_teleop_ECM_proxy_configuration_h
